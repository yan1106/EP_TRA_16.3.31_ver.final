...
if(Customer_TB.Text.Trim() != "" && ND_TB.Text.Trim() != "") { 
        ...
        else if((!jude_npiapp_SType(strsql_npiapp)) && jude_npiimportdata_SType(strsql_npiimportdata) && jude_npimanual_SType(strsql_npimanual))
        {
                ...
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "msg", "alert('Application File \\nNew_Customer:" + Customer_TB.Text+ "\\nNew_Device:" + ND_TB.Text+ "\\n欄位無此資料，請重新填寫!')", true);
        ...
        {
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "msg", "alert('Mamual File \\nNew_Customer:" + Customer_TB.Text + "\\nNew_Device:" + ND_TB.Text + "\\n欄位無此資料，請重新填寫!')", true);
        }
        else if(jude_npiapp_SType(strsql_npiapp) && (!jude_npiimportdata_SType(strsql_npiimportdata)) && (!jude_npimanual_SType(strsql_npimanual)))
        {
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "msg", "alert('DIF/Q&R/DRC/  & Mamual File \\nNew_Customer:" + Customer_TB.Text + "\\nNew_Device:" + ND_TB.Text + "\\n欄位無此資料，請重新填寫!')", true);
        }
        else if((!jude_npiapp_SType(strsql_npiapp)) && (jude_npiimportdata_SType(strsql_npiimportdata)) && (!jude_npimanual_SType(strsql_npimanual)))
        {
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "msg", "alert('Application File & Mamual File \\nNew_Customer:" + Customer_TB.Text + "\\nNew_Device:" + ND_TB.Text + "\\n欄位無此資料，請重新填寫!')", true);
        }
        else if ((!jude_npiapp_SType(strsql_npiapp)) && (!jude_npiimportdata_SType(strsql_npiimportdata)) && (jude_npimanual_SType(strsql_npimanual)))
        {
        ...
        {
          ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "msg", "alert('Application File & DIF/Q&R/DRC/ & Mamual File \\n New_Customer:" + Customer_TB.Text + "\\nNew_Device:" + ND_TB.Text + "\\n欄位無此資料，請重新填寫!')", true);
        }
      }
    else
    {
